...
TypeScript 25个, Python 16个, HTML 12个, JavaScript 8个, Rust 5个, CSS 3个, C++ 2个, Go 2个, Zig 1个, Swift 1个, Shell 1个, C# 1个, Kotlin 1个, Dockerfile 1个, ? 1个, Elixir 1个

## 趋势观察

81 个 web 领域项目被追踪，其中 1 个今日同时上榜，反映该领域持续活跃。
